...
INSERT INTO "account"
VALUES (1, 'test@test.com', NULL, 'bcVKrNNT', 'a7f67850b2acac3d0944d5d4eb19a13c3bd1baeb2452f01cad0f09796561b899',
		'q0DbacacEUjx0HtOLsjs5w', '2024-10-25 05:12:08', 1, '+100002-12-31 23:59:59');
INSERT INTO "account"
VALUES (2, 'test2@test.com', 'TestAuthor', 'bcVacacT',
		'a7f67850b2acac3d0944d5d4eb19a13cxxxxbaeb2452f01cad0f09796561b899',
...
VALUES (1, 2, NULL, NULL, '2025-12-20 12:00:00');
INSERT INTO "project_access"
VALUES (2, 3, 'secretpass123', '2026-01-20 12:00:00', '2025-12-20 12:00:00');
...
CREATE INDEX IF NOT EXISTS "idx_project_access_project_id" ON "project_access" (
	"project_id"
	);
COMMIT;
